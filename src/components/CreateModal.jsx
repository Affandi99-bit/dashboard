        ...
        >
          <div className="absolute top-3 left-3">
            <section className="relative rounded-lg  bg-dark shadow-lg h-full">
              ...
              <p className="helvetia font-bold text-2xl text-white">CREATE NEW TASK</p>
              <button
              ...
              <form className="w-full h-full flex flex-col gap-1 p-2">
...
<div className="flex size-20 items-center justify-center w-full">
    <label htmlFor="dropzone-file" className="flex flex-col items-center justify-center w-full h-20 bg-white rounded-md cursor-pointer">
        <div className="flex gap-3 items-center justify-center">
            ...
            <p className="montserrat text-gray-400">Click or drag to upload BA file</p>
        </div>
        <input id="dropzone-file" type="file" className="hidden" />
                    ...
                    <textarea placeholder="Note" type="text" className="rounded-md p-2 w-full h-32 montserrat" />
              
                    </div>
                    <div className="flex gap-1">

                    <button className=" bg-red-500 text-white montserrat rounded-md py-2 w-full font-semibold tracking-wide">
                 Delete
                </button>
                    <button className=" bg-green-500 text-white montserrat rounded-md py-2 w-full font-semibold tracking-wide">
                  Submit
                </button>
                    </div>
              </form>
